...
namespace vcmiextract
{
	...
	void save_image(basic_image_ptr data, const std::filesystem::path& destination, std::string filename);
	void save_file(memory_file& data, const std::filesystem::path& destination, std::string filename);
